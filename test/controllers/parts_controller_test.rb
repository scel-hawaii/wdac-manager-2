...
class PartsControllerTest < ActionController::TestCase
  ...
  test "should create part" do
    assert_difference('Part.count') do
      post :create, part: { description: @part.description, name: @part.name, part_id: @part.part_id }
    end
  ...
  test "should update part" do
    patch :update, id: @part, part: { description: @part.description, name: @part.name, part_id: @part.part_id }
    assert_redirected_to part_path(assigns(:part))
  end
