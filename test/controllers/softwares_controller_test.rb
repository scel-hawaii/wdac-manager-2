...
class SoftwaresControllerTest < ActionController::TestCase
  ...
  test "should create software" do
    assert_difference('Software.count') do
      post :create, software: { notes: @software.notes, software_id: @software.software_id, version: @software.version }
    end
  ...
  test "should update software" do
    patch :update, id: @software, software: { notes: @software.notes, software_id: @software.software_id, version: @software.version }
    assert_redirected_to software_path(assigns(:software))
  end
